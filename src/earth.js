...
/*
Here in earth.js, we used the same modules as we used in moon.js. 
The only new module we use here is async, which is used to generate peerIds 
for moon and earth peers, in parallel.
*/
'use strict'
/* eslint-disable no-console */
